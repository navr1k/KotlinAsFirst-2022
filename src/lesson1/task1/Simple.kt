...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val sumVer = (sagenes * 48) + (arshins / 3.0 * 48) + vershoks
    val sumSm = sumVer * 4.445
    val sumMetr = sumSm / 100
    return sumMetr
}
...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    val qtySecond = (deg * sqr(60) + (min * 60) + sec)
    val qtyRadian = qtySecond / 206264.806
    return qtyRadian
}
